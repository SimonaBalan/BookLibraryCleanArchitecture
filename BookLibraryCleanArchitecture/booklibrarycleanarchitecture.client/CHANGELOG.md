...
- Create Angular project with ng: `ng new booklibrarycleanarchitecture.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`booklibrarycleanarchitecture.client.esproj`).
